    ...
    public List<List<HashMap<String,String>>> parse(JSONObject jObject){
        ...
        try {
            ...
            for(int i=0;i<jsonRoutes.length();i++){
                ...
                String distance_txt/*総合距離(km)*/ = (String)((JSONObject)((JSONObject)jsonLegs.get(i)).get("distance")).getString("text");

                temp += distance_txt + "<br><br>";

                String distance_val/*総合距離(m)*/ = (String)((JSONObject)((JSONObject)jsonLegs.get(i)).get("distance")).getString("value");
                ...
                for(int j=0;j<jsonLegs.length();j++){
                    ...
                    for(int k=0;k<jsonSteps.length();k++){
                        ...
                        String instructions/*どこにどういう風に進むか*/ = (String)((JSONObject)(JSONObject)jsonSteps.get(k)).getString("html_instructions");
                        String duration_value/*直線距離*/ = (String)((JSONObject)((JSONObject)jsonSteps.get(k)).get("duration")).getString("value");
                        String duration_txt/*直線移動時間*/ = (String)((JSONObject)((JSONObject)jsonSteps.get(k)).get("duration")).getString("text");
                ...
                //ルート情報が文章の状態で記述されている
                //ここへの追加の仕方を変更することで文章の見た目をいじることができる。
                ma.posinfo = temp;
            }
